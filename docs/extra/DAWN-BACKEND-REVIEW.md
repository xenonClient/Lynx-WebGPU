...
> **고지.** Dawn은 **BSD-3-Clause**(`Copyright 2017-2026 The Dawn & Tint Authors`, LICENSE
> 안의 일부 디렉터리는 Apache-2.0)다. 소스를 가져오지 않고 프리빌트 `.xcframework`를
> **DawnCheck·DawnDemo 타깃에서만** 링크한다 — 라이브러리 product는 Dawn을 모른다.
